...
Use docs/ai/project-context.md as the source of truth for this workspace.
...
If a request touches streaming behavior, preserve low latency, strong typing, and mobile-first UX.
